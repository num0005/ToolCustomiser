...
{
    /// <summary>
    /// Searches a stream using 
    /// Adapted from: https://stackoverflow.com/a/61947989 
    ...
    static class StreamSearch
    {
        ...
        /// <returns>The index of the first occurrence, or null if the pattern has not been found</returns>
        public static long? Find(Stream s, byte[] pattern)
        {
